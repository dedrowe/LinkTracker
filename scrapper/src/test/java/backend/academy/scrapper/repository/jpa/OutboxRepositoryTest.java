...
public class OutboxRepositoryTest extends AbstractJpaTest {
    ...
    private final Outbox outbox1 = new Outbox(1, "https://example.com", 1, "test description");

    private final Outbox outbox2 = new Outbox(1, "https://example.com", 2, "test description");
    ...
    public void getAllWithDeletionTest() {
        Outbox expectedResult = new Outbox(1, "https://example.com", 2, "test description");
