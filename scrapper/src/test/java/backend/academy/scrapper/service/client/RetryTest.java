...
@SpringBootTest
@ContextConfiguration(classes = {RetryWrapper.class})
@EnableRetry
public class RetryTest {
    ...
    private String getRequest(URI uri) {
        return client.get().uri(uri.getPath()).retrieve()
    ...
    public void notRetryOnExceptionTest() {
        ...
        assertThatThrownBy(() -> retryWrapper.retry(() -> getRequest(URI.create(issuesUrl)))).isInstanceOf(ApiCallException.class);
        List<Scenario> scenarios = getAllScenarios();
