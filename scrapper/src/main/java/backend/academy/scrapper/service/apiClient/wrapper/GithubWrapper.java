...
public class GithubWrapper implements ApiClientWrapper {
    ...
    private Optional<String> getRepositoryUpdate(URI uri, LocalDateTime lastUpdate) throws URISyntaxException {
    ...
    private Optional<String> getIssueUpdate(URI uri, LocalDateTime lastUpdate) throws URISyntaxException {
